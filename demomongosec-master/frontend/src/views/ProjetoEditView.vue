        ...
        <div v-if="projeto" class="card login" :class="{ error: emptyFields }">
          ...
          <fieldset>
            ...
            <form @submit.prevent="atualizaProjeto">
              ...
              <div class="row gx-3 gy-2 justify-content-center p-3">
                <div class="col-sm-4">
                  <button class="btn btn-primary btn-block" type="submit">Atualizar</button>
                </div>
                <div class="col-sm-4">
                  <button class="btn btn-danger btn-block" @click.prevent="excluiProjeto">Excluir</button>
                </div>
                <div class="col-sm-4">
                  <button class="btn btn-secondary btn-block" @click="voltar">Voltar</button>
                </div>
              </div>
            </form>
          </fieldset>
